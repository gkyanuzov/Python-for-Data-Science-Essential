...
"""
soup_object = BeautifulSoup('<h1 attribute_1 = "Heading Level 1"'
                            '">Future trends for IoT in 2018</h1',
                            'lxml')
tag = soup_object.h1
print(type(tag))
print(tag.string)
print(type(tag.string)) # --> NavigatableString

navi_string = tag.string
navi_string = navi_string.replace_with('NaN')
print(navi_string)
print('---------------------------')
""""

Utilize NavigatableStrings

"""
soup_object1 = BeautifulSoup(our_html_document, 'html.parser')
for string in soup_object1.stripped_strings:
    print(repr(string))

first_link = soup_object1.a
print(first_link)
print(first_link.parent) # gets the parent tag
