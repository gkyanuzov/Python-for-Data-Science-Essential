...
# print(soup_object)
# print(soup_object.prettify()[0:300])
...
soup_object_1 = BeautifulSoup('<h1 attribute_1 = "Heading Level 1"'
                              '">future trends for IoT in 2018</h1', 'lxml')

tag = soup_object_1.h1
# print(type(tag))
# print(tag)
# print(tag.name)

# Tag attributes
soup_object2 = BeautifulSoup('<h1 attribute_1 = "Heading Level 1"'
                              '">future trends for IoT in 2018</h1', 'lxml')
tag2 = soup_object2.h1
print(tag2)
print(tag2['attribute_1'])
print(tag2.attrs)

tag2['attribute_2'] = 'Heading Level 1'
print(tag2.attrs)
del tag2['attribute_2']
print(tag2.attrs)
del tag2['attribute_1']
print(tag2.attrs)

""""

Navigate a parse tree using trees

"""
print(soup_object.head)
print('------------------------------------------')
print(soup_object.title)
print('------------------------------------------')
print(soup_object.body.b)
print('------------------------------------------')
print(soup_object.body)
print('------------------------------------------')
print(soup_object.li)
print('------------------------------------------')
print(soup_object.a)
print('------------------------------------------')
